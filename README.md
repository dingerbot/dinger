...
**Level 3:** it reads your mind. <br><br>To see the calculations in action and the conversation it's trying to match, open up the developer console `command + option + j`
